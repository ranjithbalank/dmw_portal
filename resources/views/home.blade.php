                ...
                <div class="bg-glass p-3 rounded-bottom-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('roles.index') }}" class="glass-card border border-1 border-dark">
                                <i class="bi bi-person-lock fs-2 mb-1 text-primary"></i>
                                <span class="fw-semibold small">Roles</span>
                            </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="{{ route('permissions.index') }}" class="glass-card border border-1 border-dark">
        ...
        <div class="col-12">
            <div class="rounded-4 overflow-hidden shadow border border-1 border-dark">
                ...
                <div class="bg-glass p-3 rounded-bottom-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('users.index') }}" class="glass-card border border-1 border-dark">
        ...
        <div class="col-12">
            <div class="rounded-4 overflow-hidden shadow border border-1 border-dark">
                ...
                <div class="bg-glass p-3 rounded-bottom-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('leaves.index') }}" class="glass-card border border-1 border-dark">
                                <i class="bi bi-calendar-check-fill fs-2 mb-1 text-warning"></i>
                                <span class="fw-semibold small">Leaves</span>
                            </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="{{ route('holidays.index') }}" class="glass-card border border-1 border-dark">
        ...
        <div class="col-12">
            <div class="rounded-4 overflow-hidden shadow border border-1 border-dark">
                ...
                <div class="bg-glass p-3 rounded-bottom-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('asset-tickets.index') }}" class="glass-card border border-1 border-dark">
        ...
        <div class="col-12">
            <div class="rounded-4 overflow-hidden shadow border border-1 border-dark">
                ...
                <div class="bg-glass p-3 rounded-bottom-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="{{ route('internal-jobs.index') }}" class="glass-card border border-1 border-dark">
