        ...
        <div class="card shadow-sm rounded-4 border-1">
            <div class="card-header d-flex justify-content-between align-items-center  bg-tertiary"
                ...
                <span class="fw-semibold">
                    <i class="bi bi-plus-circle text-white me-2"></i> View Facility Ticket
                </span>
                        ...
                        <div class="p-3">
                            <div class="row mb-3">
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-primary fw-semibold border-end-1">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-success fw-semibold border-end-0">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-info fw-semibold border-end-0">
                            ...
                            {{-- <div class="row mb-2">
                                <div class="col-md-3 mb-2">
                                    <select name="category_id" class="form-select select2 shadow-sm rounded-3" >
                                ...
                                <div class="col-md-3 mb-2">
                                    <select name="unit" class="form-select shadow-sm rounded-3">
                                ...
                                <div class="col-md-3 mb-2">
                                    <select name="division" class="form-select shadow-sm rounded-3">
                                        <option value="">Select Division</option>
                                        <option value="Perundurai">Production</option>
                                        <option value="Coimbatore - 1">IT SERVICE</option>
                                        <option value="Corporate">STORES</option>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="input-group shadow-sm rounded-3">
                                        <span class="input-group-text bg-white text-secondary fw-semibold border-end-0">
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="input-group shadow-sm rounded-3">
                                        <span class="input-group-text bg-white text-warning fw-semibold border-end-0">
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="input-group shadow-sm rounded-3">
                                        ...
                                        <select name="status" class="form-select select2status border-start-0" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2">
                                    <br>
                                    <div class="input-group shadow-sm rounded-3">
                                        <span class="input-group-text bg-white fw-semibold border-end-0">
                                            Issue Title
                                        </span>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span
                                            ...
                                            To</span>
                                        <input type="text" name="assigned_to" class="form-control border-start-0">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                    ...
                    <div class="card mb-3 shadow-sm rounded-3 border-1">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-danger fw-semibold border-end-0">Closed
                                            By</span>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-danger fw-semibold border-end-0">Closed
                                            On</span>
                                        <input type="date" name="closed_on" class="form-control border-start-0">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span class="input-group-text bg-white text-danger fw-semibold border-end-0">Closed
                                            Reason</span>
                                        <input type="text" name="closed_reason" class="form-control border-start-0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span
                                            class="input-group-text bg-white text-warning fw-semibold border-end-0">Reopen
                                            By</span>
                                        <input type="text" name="reopen_by" class="form-control border-start-0">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span
                                            class="input-group-text bg-white text-warning fw-semibold border-end-0">Reopened
                                            On</span>
                                        <input type="date" name="reopened_on" class="form-control border-start-0">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="input-group shadow-sm">
                                        <span
                                            class="input-group-text bg-white text-warning fw-semibold border-end-0">Reopen
                                            Reason</span>
                                        <input type="text" name="reopen_reason" class="form-control border-start-0">
                                    </div>
                                </div>
                            </div>
                        </div>
