            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body py-3">
                        <form method="POST" action="{{ route('internal-jobs.store') }}">
                            @csrf
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('job_id') is-invalid @enderror"
                                        name="job_id" id="job_id" value="{{ old('job_id', $jobId) }}" readonly>
                                    @error('job_id')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('job_title') is-invalid @enderror"
                                        name="job_title" id="job_title" value="{{ old('job_title') }}" required>
                                    @error('job_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('slot_available') is-invalid @enderror"
                                        name="slot_available" id="slot_available" value="{{ old('slot_available') }}"
                                        required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" step="0.1"
                                        ...
                                        name="work_experience" id="work_experience" value="{{ old('work_experience') }}"
                                        required>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('division') is-invalid @enderror"
                                        name="division" id="division" value="{{ old('division') }}" required>
                                    @error('division')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                        name="passing_date" id="passing_date" value="{{ old('passing_date') }}"
                                        required>
                                    @error('passing_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
