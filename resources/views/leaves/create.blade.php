                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="{{ auth()->user()->designation }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3" id="comp_off_fields" style="display: none;">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="comp_off_worked_date" id="comp_off_worked_date" class="form-control" value="{{ old('comp_off_worked_date') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="comp_off_leave_date" class="form-label fw-bold">Leave Date</label>
                                <input type="date" name="comp_off_leave_date" id="comp_off_leave_date" class="form-control" value="{{ old('comp_off_leave_date') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" min="0" step="0.5" name="leave_days" id="leave_days" class="form-control" value="{{ old('leave_days') }}" readonly>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-bold">Available Leaves</label>
                                <input type="text" class="form-control bg-light fw-bold text-success" value="{{ $availableLeaves ?? 0 }}" readonly>
                            </div>
                        </div>
