                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('unit.update', $unit->id) }}">
                            ...
                            <div class="row mb-4">
                                ...
                                <!-- Unit Code -->
                                <div class="col-md-6">
                                    <label for="code" class="form-label fw-bold">Unit Code</label>
                                    <input id="code" type="text"
                                           class="form-control @error('code') is-invalid @enderror"
                                           name="code" value="{{ old('code', $unit->code) }}" required>
                                    @error('code')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
